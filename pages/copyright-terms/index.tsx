    ...
    <>
      <SEOstatic
        page={{
          ...
          url: '/',
          desc: `Правила использования контента сайта NBHOZ`,
          keywords:
            'nbhoz, nbhoz.ru, нбхоз, Товары для сервировки стола, купить Кухонная утварь, Товары для ванной комнаты, Дешевые хозтовары',
