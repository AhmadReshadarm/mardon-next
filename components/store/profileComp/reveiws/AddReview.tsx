// components/store/profileComp/reveiws/AddReview.tsx
...
// REMOVED: import { PopupContainer } from '../common';
      ...
      <div className={styles.addReviewContainer}>
        ...
        >
          ...
          <motion.button
            ...
            style={{
              display: input.length == 0 ? 'none' : 'flex',
              width: '100%',
              padding: '15px',
        ...
        <motion.span
          ...
          variants={variants.fadeOutSlideOut}
          style={{ color: '#2e7d32', marginTop: '10px' }}
        >
          {success}
        </motion.span>
        <div
